                ...
                <div class="container-fluid">
                  ...
                  ?>
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-10">
                        <input type="text" name="volume_sampah" class="form-control" size="4" value="<?php echo $data['volume_sampah']; ?>" readonly required>
                      </div>
                    </div>
                    <div class="form-group row">
                      <label class="col-sm-2 col-form-label">Status</label>
                      <div class="col-sm-10">
                        <input type="text" name="status" class="form-control" size="4" value="<?php echo $data['status_pengangkutan']; ?>" readonly required>
                      </div>
                    </div>
                    <div class="form-group row">

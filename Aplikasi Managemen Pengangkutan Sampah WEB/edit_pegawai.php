              ...
              <div id="content">
                ...
                <div class="container-fluid">
                  ...
                  if(isset($_GET['id'])){
                    ...
                    $select = mysqli_query($koneksi, "SELECT * FROM supir WHERE id_supir='$id'") or die(mysqli_error($koneksi));
                  ...
                  if(isset($_POST['submit'])){
                    ...
                    $sql = mysqli_query($koneksi, "UPDATE supir SET nama='$nama', alamat='$alamat', telp='$telp' WHERE id_supir='$id'") or die(mysqli_error($koneksi));

                    if($sql){
                      echo '<script>alert("Berhasil menyimpan data."); document.location="pegawai.php";</script>';
                    }else{
                  ...
                  <form action="edit_pegawai.php?id=<?php echo $id; ?>" method="post">
                    <div class="form-group row">
                      <label class="col-sm-2 col-form-label">Id Supir</label>
                      <div class="col-sm-10">
                        <input type="text" name="id_supir" class="form-control" size="4" value="<?php echo $data['id_supir']; ?>" readonly required>
                      </div>
                    </div>
                    <div class="form-group row">
